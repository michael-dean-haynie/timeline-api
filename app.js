...
// get auto complete results from wikidata
...
// get wikipedia links for wikidata items
app.post('/links', async (req, res) => {

  searchParams = new Map();
  searchParams.set('action', 'wbgetentities');
  searchParams.set('format', 'json');
  searchParams.set('props', 'sitelinks/urls');
  searchParams.set('sitefilter', 'enwiki');
  searchParams.set('ids', req.body.ids.join('|'));
